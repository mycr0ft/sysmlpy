...
class Package:
    ...
    def __repr__(self):
        ...
        shortname = getattr(
            self.grammar.declaration.identification, "declaredShortName", None
        )
    ...
    def load_from_grammar(self, grammar):
        ...
        declared_shortname = (
            grammar.declaration.identification.declaredShortName
            if hasattr(grammar.declaration.identification, "declaredShortName")
            else None
        )
        ...
        for child in grammar.body.children:
            ...
            # Handle UsageElement (for usages like item Hydrogen : Fuel, action Act1)
                ...
                if hasattr(first_child, "children") and first_child.children:
                    ...
                    elif hasattr(occ, "ownedRelationship") or hasattr(
                        occ, "declaration"
                    ):
                        inner_element = occ
                    else:
            ...
            if inner_class == "ItemUsage":
                self.children.append(Item().load_from_grammar(inner_element))
            elif inner_class == "PartUsage":
                self.children.append(Part().load_from_grammar(inner_element))
            elif inner_class == "PortUsage":
                self.children.append(Port().load_from_grammar(inner_element))
            elif inner_class == "Package":
                self.children.append(Package().load_from_grammar(inner_element))
                ...
                self.children.append(Attribute().load_from_grammar(inner_element))
                ...
                self.children.append(Action().load_from_grammar(inner_element))
                ...
                if (
                    hasattr(inner_element, "declaration")
                    and hasattr(inner_element.declaration, "identification")
                    and inner_element.declaration.identification
                ):
                ...
                try:
                    if (
                        hasattr(inner_element, "declaration")
                        and inner_element.declaration
                    ):
                        decl = inner_element.declaration
                        if hasattr(decl, "declaration") and decl.declaration:
                            inner_decl = decl.declaration
                            if (
                                hasattr(inner_decl, "declaration")
                                and inner_decl.declaration
                            ):
                                feat_decl = inner_decl.declaration
                                if (
                                    hasattr(feat_decl, "identification")
                                    and feat_decl.identification
                                ):
                ...
                c.grammar = inner_element
                if (
                    hasattr(inner_element, "definition")
                    and hasattr(inner_element.definition, "declaration")
                    and inner_element.definition.declaration
                ):
                ...
                if hasattr(inner_element, "definition") and inner_element.definition:
                    if (
                        hasattr(inner_element.definition, "declaration")
                        and inner_element.definition.declaration
                    ):
                        decl = inner_element.definition.declaration
                        if hasattr(decl, "identification") and decl.identification:
                ...
                inner_class == "IndividualUsage"
                or inner_class == "IndividualUsageSimple"
            ):
                i = Individual()
                i.grammar = inner_element
                if hasattr(inner_element, "declaration") and inner_element.declaration:
