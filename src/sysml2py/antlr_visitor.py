...
def _visit_root_namespace_dict(tree):
    ...
    return {"name": "PackageBodyElement", "ownedRelationship": body_elements}
...
def _visit_definition_element_dict(def_elem_ctx, prefix=None):
    ...
    if hasattr(def_elem_ctx, "package") and def_elem_ctx.package():
        ...
        hasattr(def_elem_ctx, "attributeDefinition")
        and def_elem_ctx.attributeDefinition()
    ):
        ...
        hasattr(def_elem_ctx, "requirementDefinition")
        and def_elem_ctx.requirementDefinition()
    ):
        ctx = def_elem_ctx.requirementDefinition()
        return _make_requirement_definition_dict(ctx, prefix)
    elif (
        hasattr(def_elem_ctx, "useCaseDefinition") and def_elem_ctx.useCaseDefinition()
    ):
        ...
        hasattr(def_elem_ctx, "flowConnectionDefinition")
        and def_elem_ctx.flowConnectionDefinition()
    ):
        ...
        hasattr(def_elem_ctx, "calculationDefinition")
        and def_elem_ctx.calculationDefinition()
    ):
        ctx = def_elem_ctx.calculationDefinition()
        return _make_calculation_definition_dict(ctx, prefix)
    elif (
        hasattr(def_elem_ctx, "interfaceDefinition")
        and def_elem_ctx.interfaceDefinition()
    ):
        ctx = def_elem_ctx.interfaceDefinition()
        return _make_interface_definition_dict(ctx, prefix)
    elif (
        hasattr(def_elem_ctx, "connectionDefinition")
        and def_elem_ctx.connectionDefinition()
    ):
        ctx = def_elem_ctx.connectionDefinition()
        return _make_connection_definition_dict(ctx, prefix)
    elif (
        hasattr(def_elem_ctx, "constraintDefinition")
        and def_elem_ctx.constraintDefinition()
    ):
        ctx = def_elem_ctx.constraintDefinition()
        return _make_constraint_definition_dict(ctx, prefix)
    elif (
        hasattr(def_elem_ctx, "enumerationDefinition")
        and def_elem_ctx.enumerationDefinition()
    ):
        ctx = def_elem_ctx.enumerationDefinition()
        return _make_enumeration_definition_dict(ctx, prefix)
    elif (
        hasattr(def_elem_ctx, "allocationDefinition")
        and def_elem_ctx.allocationDefinition()
    ):
        ctx = def_elem_ctx.allocationDefinition()
        return _make_allocation_definition_dict(ctx, prefix)
    elif (
        hasattr(def_elem_ctx, "metadataDefinition")
        and def_elem_ctx.metadataDefinition()
    ):
        ctx = def_elem_ctx.metadataDefinition()
        return _make_metadata_definition_dict(ctx, prefix)
    elif (
        hasattr(def_elem_ctx, "renderingDefinition")
        and def_elem_ctx.renderingDefinition()
    ):
        ctx = def_elem_ctx.renderingDefinition()
        return _make_rendering_definition_dict(ctx, prefix)
    elif (
        hasattr(def_elem_ctx, "individualDefinition")
        and def_elem_ctx.individualDefinition()
    ):
        ...
        hasattr(def_elem_ctx, "viewpointDefinition")
        and def_elem_ctx.viewpointDefinition()
    ):
        ctx = def_elem_ctx.viewpointDefinition()
        return _make_viewpoint_definition_dict(ctx, prefix)
    elif (
        hasattr(def_elem_ctx, "concernDefinition") and def_elem_ctx.concernDefinition()
    ):
        ...
        hasattr(def_elem_ctx, "analysisCaseDefinition")
        and def_elem_ctx.analysisCaseDefinition()
    ):
        ctx = def_elem_ctx.analysisCaseDefinition()
        return _make_analysis_case_definition_dict(ctx, prefix)
    elif (
        hasattr(def_elem_ctx, "verificationCaseDefinition")
        and def_elem_ctx.verificationCaseDefinition()
    ):
    ...
    return {
        ...
        "ownedRelatedElement": {
            ...
            "ownedRelatedElement": {
                ...
                "body": {"name": "PackageBody", "ownedRelationship": body_elements},
            },
        },
    }
        ...
        "ownedRelatedElement": {
            ...
            "ownedRelatedElement": {
                ...
                "definition": {
                    ...
                    "body": {"name": "DefinitionBody", "ownedRelatedElement": []},
                },
            },
        },
    }
    ...
    return {
        ...
        "ownedRelatedElement": {
            ...
            "ownedRelatedElement": {
                ...
                "body": {"name": "RequirementBody", "item": []},
            },
        },
    }
    ...
    return {
        ...
        "ownedRelatedElement": {
            ...
            "ownedRelatedElement": {
                ...
                "body": {"name": "CaseBody", "item": [], "ownedRelationship": None},
            },
        },
    }
    ...
    return {
        ...
        "ownedRelatedElement": {
            ...
            "ownedRelatedElement": {
                ...
                "body": {"name": "CalculationBody", "part": []},
            },
        },
    }
...
def _make_calculation_usage_dict(ctx, prefix=None):
    ...
    if ctx is not None:
        ...
        if hasattr(ctx, "actionUsageDeclaration") and ctx.actionUsageDeclaration():
            ...
            hasattr(ctx, "calculationUsageDeclaration")
            and ctx.calculationUsageDeclaration()
        ):
...
def _make_constraint_usage_dict(ctx, prefix=None):
    ...
    if ctx is not None:
        ...
        if (
            hasattr(ctx, "constraintUsageDeclaration")
            and ctx.constraintUsageDeclaration()
        ):
...
def _make_flow_connection_usage_dict(ctx, prefix=None):
    ...
    if ctx is not None:
        ...
        if hasattr(ctx, "flowDeclaration") and ctx.flowDeclaration():
            ...
            hasattr(ctx, "flowConnectionDeclaration")
            and ctx.flowConnectionDeclaration()
        ):
        ...
        if fd and hasattr(fd, "featureDeclaration") and fd.featureDeclaration():
            ...
            if (
                hasattr(featd, "featureIdentification")
                and featd.featureIdentification()
            ):
    ...
    return {
        ...
        "ownedRelatedElement": {
            ...
            "ownedRelatedElement": {
                ...
                "body": {"name": "RequirementBody", "ownedRelationship": []},
            },
        },
    }
...
def _make_allocation_usage_dict(ctx, prefix=None):
    ...
    if ctx is not None:
        aud = None
        if (
            hasattr(ctx, "allocationUsageDeclaration")
    ...
    return {
        ...
        "ownedRelatedElement": {
            ...
            "ownedRelatedElement": {
                ...
                "body": {"name": "EnumerationBody", "ownedRelationship": []},
            },
        },
    }
...
def _visit_definition_body_item_dict(item_ctx):
    ...
    if (
        hasattr(item_ctx, "occurrenceUsageElement")
        and item_ctx.occurrenceUsageElement()
    ):
    ...
    if (
        not inner_element
        and hasattr(item_ctx, "definitionBodyItemContent")
        and item_ctx.definitionBodyItemContent()
    ):
        ...
        # Check nonOccurrenceUsageElement
            ...
            hasattr(content, "nonOccurrenceUsageElement")
            and content.nonOccurrenceUsageElement()
        ):
    ...
    return {
        ...
        "ownedRelationship": [
            {"name": wrapper, "prefix": None, "ownedRelatedElement": owned}
        ],
    }
...
def _visit_nested_occurrence_usage(occ_elem):
    ...
    if hasattr(occ_elem, "structureUsageElement") and occ_elem.structureUsageElement():
        ...
        if hasattr(struct_elem, "partUsage") and struct_elem.partUsage():
            ...
            return _make_nested_usage_element(
                "PartUsage", name, shortname, None, body_items, typed_by
            )
            ...
            typed_by = _get_usage_typed_by(ctx)
            return _make_nested_usage_element(
                "ItemUsage", name, shortname, None, body_items, typed_by
            )
            ...
            typed_by = _get_usage_typed_by(ctx)
            return _make_nested_usage_element(
                "PortUsage", name, shortname, None, body_items, typed_by
            )
        ...
        return {
            ...
            "ownedRelatedElement": {
                ...
                "usage": {
                    ...
                    "body": {"name": "UsageBody", "ownedRelationship": []},
                },
            },
        }
...
def _make_literal_integer_primary(value):
    ...
    return {
        ...
        "base": {
            "name": "BaseExpression",
            "ownedRelationship": {"name": "LiteralInteger", "value": str(value)},
        },
        "ownedRelationship1": [],
        "ownedRelationship2": [],
    }
...
def _make_literal_real_primary(value):
    ...
    return {
        ...
        "base": {
            "name": "BaseExpression",
            "ownedRelationship": {"name": "LiteralReal", "value": str(value)},
        },
        "ownedRelationship1": [],
        "ownedRelationship2": [],
    }
...
def _make_literal_string_primary(value):
    ...
    return {
        ...
        "base": {
            "name": "BaseExpression",
            "ownedRelationship": {"name": "LiteralString", "value": value},
        },
        "ownedRelationship1": [],
        "ownedRelationship2": [],
    }
...
def _make_nested_usage_element(
    usage_type, name, shortname, prefix, body_items=None, typed_by=None
):
...
def _visit_nested_usage(usage_elem_ctx):
    ...
    if (
        hasattr(usage_elem_ctx, "occurrenceUsageElement")
        and usage_elem_ctx.occurrenceUsageElement()
    ):
        occ_elem = usage_elem_ctx.occurrenceUsageElement()

        # Check structure usage elements
        if (
            hasattr(occ_elem, "structureUsageElement")
            and occ_elem.structureUsageElement()
        ):
            struct_elem = occ_elem.structureUsageElement()
            ...
            if hasattr(struct_elem, "partUsage") and struct_elem.partUsage():
                ...
                if hasattr(ctx, "usage") and ctx.usage():
                    ...
                    if (
                        usage
                        and hasattr(usage, "usageDeclaration")
                        and usage.usageDeclaration()
                    ):
                        ud = usage.usageDeclaration()
                        if ud and hasattr(ud, "identification") and ud.identification():
                            ident = ud.identification()
        ...
        # Check behavior usage elements (action)
        if (
            hasattr(occ_elem, "behaviorUsageElement")
            and occ_elem.behaviorUsageElement()
        ):
            behav_elem = occ_elem.behaviorUsageElement()
    ...
    if (
        hasattr(usage_elem_ctx, "nonOccurrenceUsageElement")
        and usage_elem_ctx.nonOccurrenceUsageElement()
    ):
    ...
    if (
        ...
        if (
            ...
            if hasattr(struct_elem, "partUsage") and struct_elem.partUsage():
                ...
                hasattr(struct_elem, "connectionUsage")
                and struct_elem.connectionUsage()
            ):
                ctx = struct_elem.connectionUsage()
                return _make_connection_usage_dict(ctx, prefix)
            elif (
                hasattr(struct_elem, "flowConnectionUsage")
                and struct_elem.flowConnectionUsage()
            ):
                ...
                hasattr(struct_elem, "allocationUsage")
                and struct_elem.allocationUsage()
            ):
                ctx = struct_elem.allocationUsage()
                return _make_allocation_usage_dict(ctx, prefix)
            elif (
                hasattr(struct_elem, "renderingUsage") and struct_elem.renderingUsage()
            ):
                ctx = struct_elem.renderingUsage()
                return _make_rendering_usage_dict(ctx, prefix)
            elif (
                hasattr(struct_elem, "individualUsage")
                and struct_elem.individualUsage()
            ):
        ...
        if (
            ...
            if hasattr(behav_elem, "stateUsage") and behav_elem.stateUsage():
                ...
                hasattr(behav_elem, "calculationUsage")
                and behav_elem.calculationUsage()
            ):
                ctx = behav_elem.calculationUsage()
                return _make_calculation_usage_dict(ctx, prefix)
            elif (
                hasattr(behav_elem, "constraintUsage") and behav_elem.constraintUsage()
            ):
                            ...
                            if hasattr(ident, "name"):
                                ...
                                if name_list and isinstance(name_list, list):
                                    if len(name_list) == 2:
                                        ...
                                        name_text = name_list[0].getText()
                                        name, shortname = _extract_name_shortname(
                                            name_text
                                        )
...
def _make_usage_dict(
    ...
    if wrapped:
        ...
        return {"name": "UsageElement", "ownedRelatedElement": inner_usage}
...
def _get_usage_typed_by(ctx):
    ...
    if (
        ud
        and hasattr(ud, "featureSpecializationPart")
        and ud.featureSpecializationPart()
    ):
